...
(function(){
  ...
  function setLang(lang) {
    currentLang = lang;
    localStorage.setItem('bustan-lang', lang);
  ...
  function showIndicator(lang) {
    let ind = document.getElementById('bustan-lang-indicator');
    if (!ind) {
      ind = document.createElement('div');
      ind.id = 'bustan-lang-indicator';
  ...
  // --- Auto-inject CSS ---
  function injectCSS() {
    if (document.getElementById('bustan-lang-css')) return;
    const style = document.createElement('style');
    style.id = 'bustan-lang-css';
    style.textContent = `
  ...
  function init() {
    ...
    const saved = localStorage.getItem('bustan-lang');
    if (saved && saved !== 'he') {
      setLang(saved);
    }
  }
